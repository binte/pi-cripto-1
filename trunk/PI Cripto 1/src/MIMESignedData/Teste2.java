 ...
 */
 ...
 import java.io.FileOutputStream;
        ...
        public class Teste2 {
            ...
            static AuthorityKeyIdentifier createAuthorityKeyId(PublicKey pub)
                    throws IOException {
                ByteArrayInputStream bIn = new ByteArrayInputStream(pub
                        .getEncoded());
            ...
            static SubjectKeyIdentifier createSubjectKeyId(PublicKey pub)
                    throws IOException {
                ByteArrayInputStream bIn = new ByteArrayInputStream(pub
                        .getEncoded());
             ...
             */
            static X509Certificate makeCertificate(KeyPair subKP, String subDN,
                ...
                v3CertGen.addExtension(X509Extensions.SubjectKeyIdentifier,
                        false, createSubjectKeyId(subPub));

                v3CertGen.addExtension(X509Extensions.AuthorityKeyIdentifier,
                        false, createAuthorityKeyId(issPub));
            ...
            public static void main(String args[]) throws Exception {
                ...
                X509Certificate signCert = makeCertificate(signKP, signDN,
                        signKP, signDN);
                ...
                X509Certificate origCert = makeCertificate(origKP, origDN,
                        signKP, signDN);
